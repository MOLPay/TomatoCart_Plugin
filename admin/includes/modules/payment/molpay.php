...
class osC_Payment_molpay extends osC_Payment_Admin {
    ...
    function install() {
        ...
        $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('MOLPay Merchant ID:', 'MODULE_PAYMENT_MOLPAY_SELLER_ID', '','MOLPay Merchant ID.', '6', '0', now())");
        $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('MOLPay Verify Key:', 'MODULE_PAYMENT_MOLPAY_SECRET_WORD', '', 'Please refer to your MOLPay Merchant Profile for this key.', '6', '0', now())");
    ...
    function getKeys() {
        if (!isset($this->_keys)) {
            $this->_keys = array(
                ...
                'MODULE_PAYMENT_MOLPAY_SELLER_ID',
                'MODULE_PAYMENT_MOLPAY_SECRET_WORD',
